        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <?php $i = 1; ?>
                        <?php foreach ($income as $row2): ?>
                            <tr>
                                <td class="text-center"><?= $i ?></td>
                                <td><?= htmlspecialchars($row2["id_sales"]) ?></td>
                                <td>Rp <?= number_format($row2["total"], 0, ',', '.') ?></td>
                                <td><?= htmlspecialchars($row2["tanggal"]) ?></td>
                            </tr>
                            <?php $i++; ?>
                        <?php endforeach; ?>
                    <?php endif; ?>
